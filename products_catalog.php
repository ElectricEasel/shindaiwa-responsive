	...
	<div class="body">
		...
		<div id="content-container">
			<main id="content">
				...
				<div class="catalog-download text-center container-fluid">
					<div class="container">
						<div class="row">
							<div class="catalog-download__img">
								<img src="/images/temp/products_catalog.png" title="" alt="">
							</div>
							<div class="catalog-download__buttons">
								<a href="#" class="btn btn-red">Full Catalog PDF</a>
								<a href="#" class="btn btn-red">View full flipbook</a>
							</div>
						</div>
					</div>
				</div>

				<div class="container-fluid products-cat">
					<div class="container">
						<div class="products-cat__title text-center">
							Choose a product category to download individual catalog pages:
						</div>
						<div class="row">
