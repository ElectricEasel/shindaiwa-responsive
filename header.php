	<!-- Menu Toggle -->
	<div id="backdrop" class="collapsed"></div>
			...
			<div class="row">
				<div class="container">
					<div class="header-inner container-fluid clearfix">
						<div id="nav-toggle" class="pull-left"  data-toggle="main-nav">
							<div class="hidden-md hidden-lg bar-btn">
								<div class="bar-block">
									<span class="bar"></span>
									<span class="bar"></span>
									<span class="bar"></span>
						...
						<a class="brand logo " href="/">
							<img src="/images/logo-small.png" alt="Shindaiwa" class="normal-image" />
							<img src="/images/logo-small@2x.png" alt="Shindaiwa" class="retina-image" />
						</a>
						<div class="header__search-btn pull-right visible-xs">
							<span class="glyphicon glyphicon-search"></span>
						</div>
						<ul class="social hidden-xs">
							<li><a target="_blank" class="facebook" href="https://www.facebook.com/ECHOUSA"></a></li>
							<li><a target="_blank" class="youtube" href="http://www.youtube.com/echousa"></a></li>
							<li><a target="_blank" class="instagram" href="http://instagram.com/echousa"></a></li>
						</ul>
						<form action="#" class="header__search">
								<input type="search" class="header__input-search" placeholder="search...">
								<input type="submit" value="" class="header__search-submit">
						</form>
					</div>

				</div>
			</div>
			<div id="backdrop1" class="collapsed"></div>
