	...
	<div class="body">
		...
		<div class="container-fluid visible-xs compare-top">
			<div id="product--btn" class="compare-top__btn"  data-toggle="product-sidebar">
				<a href="#" class="compare-top__link compare-top__text">Accessories</a>
			</div>
			<span class="compare-top__divider divider">|</span>
			<span class="compare-top__text">Brushcutter Accessories</span>
		</div>

		<div class="banner-inner" >
			<div class="container banner-inner__text text-left text-uppercase">
				<h1 class="banner-inner__title">Accessories</h1>
			</div>
		</div>
		...
		<div id="content-container">
			<main id="content">
				...
				<div class="container compare-wrapper compare-wrapper--goods-cat">
					<div class="row">
						<div class="col-md-3 ">
							<div class="about-aside collapsed" id="product-sidebar">
								...
								<ul class="about-aside__list ">
									...
									<li class="active">
										...
										<ul class="about-aside__sublist ">
											<li class="active"><a href="#">Brushcutters</a></li>
											<li><a href="#">Chain Saws</a></li>
											<li><a href="#">Edgers</a></li>
											<li><a href="#">Hedge Trimmers</a></li>
											<li><a href="#">Multi-Tool</a></li>
											...
											<li><a href="#">Spreaders</a></li>
											<li><a href="#">Trimmer Heads</a></li>
											<li><a href="#">Trimmer Line</a></li>
											<li><a href="#">Trimmers</a></li>
						...
						<div class="compare col-md-9">
							...
							<div class="compare__subtitle compare__subtitle--acc">
								A whole range of accessories is available to add even more versatility and convenience
